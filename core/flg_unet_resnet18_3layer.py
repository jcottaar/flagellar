...
class ResNet18_D_3D(nn.Module):
    def __init__(self,in_channels):
        super(ResNet18_D_3D, self).__init__()
        ...
        self.layer1 = self._make_layer(in_channels, 2)
        self.layer2 = self._make_layer(in_channels*2, 2, stride=2)
        self.layer3 = self._make_layer(in_channels*4, 2, stride=2)
        #self.layer4 = self._make_layer(in_channels*8, 2, stride=2)
...
class UNetResNet18_3D(nn.Module):
    def __init__(self, num_classes=2, in_channels=20):
        super(UNetResNet18_3D, self).__init__()

        self.encoder = ResNet18_D_3D(in_channels)

        # Decoder layers
        #self.decoder4 = self._decoder_block(in_channels*8, in_channels*4)
