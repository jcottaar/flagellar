...
def baseline_runner(fast_mode = False):
    ...
    res.modifier_dict['moving_ratio'] = pm(0.2, lambda r:r.uniform(0.1,0.2), prep)
    ...
    res.modifier_dict['alternative_slice_selection'] = pm(False, lambda r:r.uniform()>0.5, yolo)
